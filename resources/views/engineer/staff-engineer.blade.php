...
<div class="row mr-0">
        ...
        <div class="left_bar">
            ...
            <div class="active_left_bar">
                <div class="left_bar_text">
                    ...
                    <a href="staff-engineer" class="active_button_left_bar button_left_bar">Пользователи</a>
                </div>
            </div>
            ...
            <div class="not_active_left_bar">
                <div class="left_bar_text">
                    ...
                    <a href="setting-engineer" class="not_active_button_left_bar button_left_bar">Настройки</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="staff_content col mr-0">
        ...
        @include("engineer.staffs-engineer")
