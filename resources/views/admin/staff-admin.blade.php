        ...
        <div class="left_bar">
            ...
            <div class="active_left_bar">
                <div class="left_bar_text">
                    ...
                    <a href="staff-admin" class="active_button_left_bar button_left_bar">Пользователи</a>
                </div>
            </div>
            ...
            <div class="not_active_left_bar">
                <div class="left_bar_text">
                    ...
                    <a href="project-admin" class="not_active_button_left_bar button_left_bar">Проекты и
                        задачи</a>
                </div>
            </div>
